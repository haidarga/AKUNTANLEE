...
function createInitialState(): FinovaV4State {
  ...
  const engagement1: EngagementV4 = {
    ...
    tenantId: 'TENANT-001',
    clientId: 'CLI-001',
    name: 'Financial Review & Lead Schedule FY 2025',
  ...
  const file1: FileVersion = {
    ...
    versionNumber: 1,
    originalName: 'TB_PT_Nusantara_Sukses_Makmur_FY2025.xlsx',
    storageKey: 'engagements/ENG-2025-01/sources/9f83a48e_TB_PT_Nusantara_Sukses_Makmur_FY2025.xlsx',
  ...
  const auditEvents: AuditEventV4[] = [
    ...
    },
    {
      ...
      metadata: { filename: 'TB_PT_Nusantara_Sukses_Makmur_FY2025.xlsx', size: 684200 },
    },
    {
      id: 'EVT-003',
      tenantId: 'TENANT-001',
    ...
    exportArtifacts: [
      {
        ...
        format: 'xlsx',
        filename: 'Kertas_Kerja_Induk_NSM_FY2025_Final.xlsx',
        checksumSha256: '9f83a48e71c9b204683bc48b3017fa489110756e4c7717bc2d043444fb9a7b92',
        status: 'complete',
