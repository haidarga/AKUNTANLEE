...
export const DEFAULT_CREDENTIALS: Record<string, string> = {
  ...
  'rina.asmara@advisory-partner.id': 'Partner123!',
  'rina@kap.id': 'Partner123!',
  'bunda@pajak-kap.co.id': 'Partner123!',
  'bunda@kap.id': 'Partner123!',
...
function seedDefaultUsers(db: Database.Database) {
  ...
  const initialUsers: DbUser[] = [
    ...
    },
    {
      ...
      password_hash: bcrypt.hashSync(DEFAULT_CREDENTIALS['rina.asmara@advisory-partner.id'], 10),
      name: 'Ibu Rina Asmara, Ak.',
      role: 'partner',
      title: 'Senior Financial Advisory Partner & Former Corporate CFO',
      cpa_license: 'AK.7821-CFO',
      created_at: '2026-01-01T00:00:00Z',
    },
    {
      id: 'USR-RINA-02',
      email: 'rina@kap.id',
      password_hash: bcrypt.hashSync(DEFAULT_CREDENTIALS['rina@kap.id'], 10),
      name: 'Ibu Rina Asmara, Ak.',
      role: 'partner',
      title: 'Senior Financial Advisory Partner & Former Corporate CFO',
      cpa_license: 'AK.7821-CFO',
    ...
    },
    {
      ...
      password_hash: bcrypt.hashSync(DEFAULT_CREDENTIALS['bunda@pajak-kap.co.id'], 10),
      name: 'Bunda',
      role: 'partner',
      title: 'Partner Kepatuhan Pajak & Audit Operasional',
      cpa_license: 'BKP.9921',
      created_at: '2026-01-01T00:00:00Z',
    },
    {
      id: 'USR-BUNDA-02',
      email: 'bunda@kap.id',
      password_hash: bcrypt.hashSync(DEFAULT_CREDENTIALS['bunda@kap.id'], 10),
      name: 'Bunda',
      role: 'partner',
      title: 'Partner Kepatuhan Pajak & Audit Operasional',
      cpa_license: 'BKP.9921',
